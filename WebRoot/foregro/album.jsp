        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-8 col-md-9" id="rightBox">
                ...
                <div class="positionBox">
                    <div class="titleBar">
                        <h1>当前位置</h1>
                        <span></span>
                        <a href="index.jsp">首页</a> > <a href="album.jsp">案例中心</a>
                    </div>
                </div>
                ...
                <div class="col-sm-12 col-md-12 pad">
                    ...
                    <div class="productList">
                        ...
                        <div class="col-xs-6 col-sm-4 col-md-3 col-mm-6 productImg">
                            <a title="公司相册" href='album_detail.jsp'>
                                <span class="imgLink-hover"><span class="hover-link"></span></span>
                                <img src="images/albums/1.jpg" alt="公司相册" />
                            </a>
                            <a class="productTitle" href="album_detail.jsp" title="公司相册">
                                公司名称
                            </a>
                        </div>
            ...
            <div class="col-xs-12 col-sm-4 col-md-3">
                ...
                <div class="navigationBox" id="classification">
                    ...
                    <div class="list">
                        <ul id="firstpane">
                            <li><a class='' href='album.jsp'>合作案例</a></li>
                        </ul>
                    </div>
                </div>
