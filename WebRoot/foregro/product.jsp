            ...
            <div class="col-xs-12 col-sm-8 col-md-9" id="rightBox">
                ...
                <div class="positionBox">
                    <div class="titleBar">
                        <h1>当前位置</h1>
                        <span></span>
                        <a href="index.html">首页</a> > <a href="product.jsp">产品中心</a>
                    </div>
                </div>
...
　　   用人单位与劳务派遣机构共同约定一个时间段来聘用和落实被派遣的人才。
                            <br /><br />
                                试用派遣
　　   用人单位在试用期间将新员工转至派遣公司，然后以派遣的形式试用。
                            <br /><br />
                            双休日派遣
　　以周六、周日为基本计价单位派遣人员。
                            <br /><br />
            ...
            <div class="col-xs-12 col-sm-4 col-md-3">
                ...
                <div class="navigationBox" id="classification">
                    ...
                    <div class="list">
                        <ul id="firstpane">                         
                            <li><a class='' href='product.jsp'>钟点派遣</a></li>
                            <li><a class='' href='product.jsp'>集体派遣</a></li>
                             <li><a class='' href='product.jsp'>晚间派遣</a></li>
                            <li><a class='' href='product.jsp'>短期派遣</a></li>
                             <li><a class='' href='product.jsp'>试用派遣</a></li>
                            <li><a class='' href='product.jsp'>双休日派遣</a></li>
                        </ul>
                    </div>
                </div>
