    ...
    <div class="banner homeBanner">
        <div class="slider">
            <ul class="slider__wrapper">
                ...
                <li class="slider__item"><a target="_blank" title="2" href="" style="background-image:url(images/2.jpg)"><img src="images/banner-1.png" alt="MojoCube 官方" /></a></li>
            </ul>
        </div>
    </div>
        ...
        <div class="row">
                ...
                <div class="col-sm-12 col-md-12 pad">
                    ...
                    <div class="detailContent">
                        ...
                        <span style="color:#505050;font-family:Verdana, Arial, Helvetica, sans-serif;font-size:14px;line-height:22px;">
                           消防安全意识能使广大员工熟悉有关安全规章制度和安全操作规程，具备必要的安全知识，掌握必要的安全操作技能，增强预防事故、提高应急处理的能力。消防安全意识是企业安全的重要内容，搞好对全体员工的安全教育，
                           对提高企业安全水平具有重要作用。为进一步提高员工的消防安全意识，让员工感受到消防安全的重要性，英联中才配合成都消防总局开展了消防安全知识讲座。
                            <br /><br />
                             讲座运用图片资料、视频等讲解了消防安全工作的重要性、火险的识别、初期火灾处置、灭火器的构造和使用方法等消防常识; 并紧紧围绕家庭防火知识，消防急救，逃生自救，
                             灭火常识等，并向大家介绍了灭火器，防烟面具，逃生绳等消防设备的使用方法及日常生活中应注意的消防安全细节以及如何扑救初期火灾，火灾中如何自救、逃生等知识。
                            <br /><br />
                           “财富可以再造，生命不能重来。”通过此次讲座，不仅让员工们学到了消防安全知识，更意识到消防安全的重要性，
                           进一步增强了消防安全意识和火灾现场逃生自救能力。大家纷纷表示，一定将消防安全知识牢记心中，并向家人和朋友讲解宣传，让更多的人提高消防安全意识。
                            <br /><br />
                    ...
                    <div class="otherPageBox">
                        ...
                        <div class="col-xs-9 col-sm-9 col-md-9 pad">
                            <div class='otherPage'>
                                <div class='prevBox'>上一个：<a href='article_detail.html' title="上海泉成劳务派遣有限公司开展消防知识讲座">上海泉成劳务派遣有限公司开展消防知识讲座</a></div>
                                <div class='nextBox'>下一个：<a href='article_detail.html' title="上海泉成劳务派遣有限公司开展消防知识讲座">上海泉成劳务派遣有限公司开展消防知识讲座</a></div>
                            </div>
                        </div>
                    ...
                    <div class="aboutProduct newsBox">
                        ...
                        <ul class="newsList">
                            ...
                            <li><a href="article_detail.jsp" title="上海泉成劳务派遣有限公司开展消防知识讲座">上海泉成劳务派遣有限公司开展消防知识讲座</a></li>
                            <li><a href="article_detail.jsp" title="上海泉成劳务派遣有限公司开展消防知识讲座">上海泉成劳务派遣有限公司开展消防知识讲座</a></li>
            ...
            <div class="col-xs-12 col-sm-4 col-md-3">
                ...
                <div class="navigationBox" id="classification">
                    ...
                    <div class="list">
                        <ul id="firstpane">
                            <li><a class='firstSelected selected' href='article.jsp'>公司新闻</a></li>
