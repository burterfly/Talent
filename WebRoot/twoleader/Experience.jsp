 ...
 <ul>
  <li>
   ...
   <dd><a href="Information.jsp">个人信息</a></dd>
    <dd><a href="Experience.jsp"  class="active">履职经历</a></dd>
 ...
 <div class="rt_content">
      <div class="page_title">
       <h2 class="fl">履职经历</h2>
        ...
        <section class="mtb">      
<form:form action="${ pageContext.request.contextPath}/twoadmin/selectHousethree.do?SId=1" 
